...
| Built-in rule library | 1000+ via repos | minimal | none | secret-detection only | 20 rules |
...
4. **Sentinel's 20-rule AI-agent-defect catalog.** pre-commit has more total
