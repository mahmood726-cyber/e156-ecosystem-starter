...
OVERMIND_DEFAULT_REF="e3ab0f68cef3e9b9eac72650c6b14bb0ccad5846"   # 2026-06-04: evidence subsystem + pooling engine + gold-benchmark (measured output-correctness) + hybrid retrieval + reporting-bias. Override with OVERMIND_REF=master.
